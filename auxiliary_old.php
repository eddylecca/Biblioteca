...
/********************Validar*********************************************************/
        ...
        /*
        elseif (!isset($recuperar["authorPRI"]["idauthor"])){
            $objResponse->alert("Seleccione Autor Principal");
            $objResponse->script("xajax_displaydiv('author','titulo2')");
        }        
        elseif (!isset($recuperar["authorSEC"]["idauthor"])){
            $objResponse->alert("Seleccione Autor Secundario");
            $objResponse->script("xajax_displaydiv('author','titulo2')");
        }        
        
        
        elseif($lugar==""){
            $objResponse->alert("Ingrese lugar");
            $objResponse->script("xajax_displaydiv('lugarPais','titulo3')");
        }
        elseif($pais==""){
            $objResponse->alert("Ingrese pais");
            $objResponse->script("xajax_displaydiv('lugarPais','titulo3')");
        }
        
        elseif($evento_description==""){
            $objResponse->alert("Ingrese Nombre del evento");
            $objResponse->script("xajax_displaydiv('evento','titulo4')");
        }        

        elseif (!isset($recuperar["areasSEC"])){
            $objResponse->alert("Seleccione Area Secundaria");
            $objResponse->script("xajax_displaydiv('area_tema','titulo5')");
        }        
        
        elseif($date_ing==""){
            $objResponse->alert("Escoja una Fecha");
            $objResponse->script("xajax_displaydiv('fecha_permisos','titulo6')");
        }        
        elseif($date_pub==""){
            $objResponse->alert("Escoja una Fecha");
            $objResponse->script("xajax_displaydiv('fecha_permisos','titulo6')");
