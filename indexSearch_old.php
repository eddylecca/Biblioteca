...
/***************************************************************************************************************************************/
				...
				if(isset($form["fieldHidden"])){
					if($form["fieldHidden"]=="admin"){
						$html.="  &nbsp; &nbsp; &nbsp; <a href=# onclick=\"xajax_editShow('".$result["iddata"][$i]."'); return false;\"> Editar</a>";
					}                        
				}
				...
				$html.="<div id='".md5($result["iddata"][$i])."' style='display:none;'><p class='details'>".$resumen."</p></div>";
                                ...
                                $html.="<div id='modal_".md5($result["iddata"][$i])."' class='modal' title='Mensaje' style='display:none;color:red;'>".$mensaje_modal."</div>";
