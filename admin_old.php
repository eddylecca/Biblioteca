<?php
	...
	*******************************************/
	...
	function formPublicacionShow($iddata=0,$idSubcategory=0){
		...
		if(isset($_SESSION["editar"])){
		    if($_SESSION["editar"]==1){
		        ...
		        $tituloBoton="ACTUALIZAR";
                        ...
                        $boton='<span><input class="button" type="button" onclick="xajax_newPublication('.$iddata.',\''.$action.'\',xajax.getFormValues(\'subcategory\'));" value='.$tituloBoton.' /></span>';
			...
			$boton="";
			$linkRegresar="";
			$tituloGeneral="Ingresar publicación";
